...
@section('title', 'Daftar - CateringKu')
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div class="max-w-md w-full">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Silakan daftar untuk melanjutkan pendaftaran</p>
            </div>
            
            <!-- Tab Navigation -->
            <div class="flex mb-8 border-b">
                <a href="{{ route('login') }}" class="flex-1 py-3 px-4 text-center font-medium text-gray-500 hover:text-gray-700">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required 
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red @error('name') border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" name="phone" value="{{ old('phone') }}" required 
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red @error('phone') border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password_confirmation" required 
                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-red focus:border-brand-red" 
                               placeholder="Ulangi password">
                    </div>
                </div>
                
                <div class="flex items-center">
                    <input type="checkbox" required class="h-4 w-4 text-brand-red focus:ring-brand-red border-gray-300 rounded">
                    <label class="ml-2 block text-sm text-gray-600">
                        Saya setuju dengan 
                        <a href="#" class="text-brand-red hover:text-brand-black">Syarat & Ketentuan</a> 
                        dan 
                        <a href="#" class="text-brand-red hover:text-brand-black">Kebijakan Privasi</a>
                    </label>
                </div>
                ...
                <div class="text-center">
                    <p class="text-sm text-gray-600">
                        Sudah punya akun? 
                        <a href="{{ route('login') }}" class="text-brand-red hover:text-brand-black font-medium">Masuk di sini</a>
                    </p>
                </div>
